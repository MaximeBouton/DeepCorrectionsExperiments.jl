...
CSV.write(joinpath(parsed_args["logdir"], "log.csv"), df, append=true, writeheader=true)
CSV.write(joinpath(parsed_args["logdir"], "summary.csv"), summary, append=true, writeheader=true)
