...
for training_budget in 100000 200000 300000 400000 500000 700000 1000000; do
    expid=$((training_budget / 100000))
    nohup julia crosswalk_train.jl --training_steps=$(( training_budget/2)) --correction=corr$expid/policy_single.bson --logdir=corr$expid > $expid.$HOSTNAME.out &
    echo " nohup julia crosswalk_train.jl --training_steps=$(( training_budget/2)) --correction=corr$expid/policy_single.bson --logdir=corr$expid > $expid.$HOSTNAME.out &"
done
